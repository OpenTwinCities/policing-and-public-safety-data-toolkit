---
title: "Policing & Public Safety Data Toolkit: Police Stops Data"
output:
  html_document:
    df_print: paged
---
...
```{r}
data_file <- "../../raw_data/Minneapolis_Police_Stop_Data.csv"
...
police_stops <- police_stops_raw %>% 
  mutate(
    ...
    warning_issued = ifelse(str_detect(callDisposition, '(RPR)|(ADV)'), 'Y', 'N'),
...
**Dataset**: [Police Stop Data, Open Minneapolis](https://opendata.minneapolismn.gov/datasets/police-stop-data)
